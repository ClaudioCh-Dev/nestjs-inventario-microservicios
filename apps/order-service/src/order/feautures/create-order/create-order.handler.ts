...
import type { IOrderRepository } from 'apps/order-service/src/database/repositories/prisma.order.repository';
import { Order } from '../../entities/order.entity';
import { OrderItem } from '../../entities/order-item.entity';
import { ORDER_REPOSITORY } from 'apps/order-service/src/database/persistence.module';
